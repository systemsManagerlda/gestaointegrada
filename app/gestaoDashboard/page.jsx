  ...
  return (
    <>
        ...
        <div class="flex space-x-4">
            <Button onPress={() => router.push('/gestaoDashboard')} size="sm">Presenças</Button>
            <Button onPress={() => router.push('/gestaoDashboard')} size="sm">Fila</Button>
        ...
        {processando && (
            ...
            <table className='w-full'>
                <thead className='bg-blue-100 border=b-2 border-blue-200'>
                    <tr>
                        ...
                        <th className='w-24 p-3 text-sm font-semibold tracking-wide text-letf'>Acção</th>
                    </tr>
                </thead>
                        ...
                        <>
                         <tr className='bg-white'>
                            ...
                            {(fila.status === "Atendido") && (
                                <td className='whitespace-nowrap p-3 text-sm text-gray-700'><span className='p-1.5 text-xs font-medium uppercase tracking-wider text-blue-800 bg-blue-800 rounded-lg bg-opacity-40'>{fila.status}</span></td>
                            )}                         
                            <td className='whitespace-nowrap p-3 text-sm text-gray-700'>
                            <div class="flex space-x-4">
                                <Button onPress={() => editFilas(fila._id)} size="sm">Atendido</Button>
                                <Button flat color="error" onPress={() => deleteFilas(fila._id)} size="sm">Desistiu</Button>
                            </div>   
                            </td>
                        </tr>   
                        </>
          ...
          <Modal
            ...
            >
                ...
                <span className='mb-4 font-satoshi font-semibold text-base text-gray-700 p-1'>Sucesso!</span>                   
                </Text>
                </Modal.Header>
                <Modal.Body>
                <Text id="modal-description">
                    Acção executada com sucesso actualize a página para ver a mudança...
                </Text>
