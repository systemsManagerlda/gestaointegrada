...
const cortes = [
    {corte: 'Texturizar no Corte com Gel Pessoal', preco: '150'},
    {corte: 'Texturizar no Corte com Gel Pessoal e Laver', preco: '200'},
];
function Texturizacao() {
